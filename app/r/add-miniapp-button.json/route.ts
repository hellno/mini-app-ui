...
export async function GET() {
  ...
  // Read the add-miniapp-button.tsx component file
  const buttonPath = path.join(process.cwd(), "registry", "mini-app", "blocks", "add-miniapp-button", "add-miniapp-button.tsx");
  ...
  return NextResponse.json(addMiniappButtonJson);
} 